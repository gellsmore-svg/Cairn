...
type: Reference
title: Examples
description: Worked Cairn descriptions of the sibling projects — Tirzah, Hoglah, Mahalath, Mahlah, and Milcah — each describing a real process in the language, doubling as a stress test of the spec.
resource: https://github.com/gellsmore-svg/Cairn/tree/main/examples
tags: [cairn, examples, tirzah, hoglah, mahalath, mahlah, milcah]
